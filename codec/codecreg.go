...
func getPackageByCodecName(name string) string {
	switch name {
	case "binary":
		return "github.com/luis-quan/cellnet/codec/binary"
	case "gogopb":
		return "github.com/luis-quan/cellnet/codec/gogopb"
	case "httpjson":
		return "github.com/luis-quan/cellnet/codec/httpjson"
	case "json":
		return "github.com/luis-quan/cellnet/codec/json"
	case "protoplus":
		return "github.com/luis-quan/cellnet/codec/protoplus"
	default:
