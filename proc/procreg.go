...
func getPackageByCodecName(name string) string {
	switch name {
	case "gorillaws.ltv":
		return "github.com/luis-quan/cellnet/proc/gorillaws"
	case "http":
		return "github.com/luis-quan/cellnet/proc/http"
	case "tcp.ltv":
		return "github.com/luis-quan/cellnet/proc/tcp"
	case "udp.ltv":
		return "github.com/luis-quan/cellnet/proc/udp"
	default:
